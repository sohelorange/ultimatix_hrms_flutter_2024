class AppString {
  ...
  static const String orangeTechnoLabPvt = 'Orange Technolab Pvt. Ltd';
  ...
  static const String enterUserName = "Enter Login ID";
  static const String enterpassword = "Enter Password";
  static const String rememberMe = "Remember Me";
  static const String forgotPassWord = "Forgot Password?";
  static const String forgotname = "Registered Login ID";
  static const String serverConnection = "Server Connection";
  static const String servername = "Please enter server name";
  static const String enterservername = "Enter Server Name";
  static const String google = "Continue with Google";
  static const String resetPassword = "Reset Password";
  static const String webId = "www.payrollsoftware.co.in";
  static const String backToLoginText = "Back to Payroll Login Page";
