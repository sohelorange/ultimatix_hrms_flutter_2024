                          ...
                          children: [
                            ...
                            Expanded(
                              child: Container(
                                ...
                                child: Row(
                                  children: [
                                    SvgPicture.asset(AppImages.svgPresent),
                                    // Location Icon
                                    const SizedBox(width: 8.0),
                                    Expanded(
                                      child: Column(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Container(
                                ...
                                child: Row(
                                  children: [
                                    SvgPicture.asset(AppImages.svgLateIn),
                                    // Clock Icon
                                    const SizedBox(width: 8.0),
                                    Expanded(
                                      child: Column(
                            ...
                            Expanded(
                              child: Container(
                                ...
                                child: Row(
                                  children: [
                                    SvgPicture.asset(AppImages.svgEarlyOut),
                                    // Location Icon
                                    const SizedBox(width: 8.0),
                                    Expanded(
                                      child: Column(
                                ...
                                children: [
                                        ...
                                        items: controller
                                          ...
                                          (element) {
                                            return DropdownMenuItem(
                                                value: element.reasonName,
                                                child: Text(element.reasonName
                                                    .toString()));
                                          },
                                        ).toList(),
                                        menuMaxHeight:
                                  ...
                                  Container(
                                    ...
                                    child: DropdownButtonFormField<String>(
                                      value: controller.listOfType.elementAt(
                                      ...
                                      onChanged: (String? value) {
                                        if (value != null) {
                                          for (int i = 0;
                                              i < controller.listOfType.length;
                                              i++) {
                                            if (value ==
                                                controller.listOfType
                                                    .elementAt(i)) {
                                              controller
                                      ...
                                      items: controller.listOfType.map(
                                        (element) {
                                          return DropdownMenuItem(
                                              value: element,
                                              child: Text(element));
                                        ...
                                        children: [
                                          Obx(
                                            () => Checkbox(
                                              ...
                                              value: controller
                                                  .isCancelLateIn.value,
                                              shape: RoundedRectangleBorder(
                                                borderRadius:
                                                    BorderRadius.circular(4),
                                              ),
                                              onChanged: (bool? value) {
                                                controller.isCancelLateIn
                                                    .value = value!;
                                              },
                                            ),
                                          ),
                                          ...
                                          Obx(
                                            () => Checkbox(
                                              ...
                                              activeColor:
                                                  AppColors.purpleSwatch,
                                              value: controller
                                                  .isCancelEarlyOut.value,
                                              shape: RoundedRectangleBorder(
                                                borderRadius:
                                                    BorderRadius.circular(4),
                                              ),
                                              onChanged: (bool? value) {
                                                controller.isCancelEarlyOut
                                                    .value = value!;
                                              },
                                            ),
                                          ),
