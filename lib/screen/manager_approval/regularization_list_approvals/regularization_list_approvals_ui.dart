...
class RegularizationListApprovalsUi
    extends GetView<RegularizationListApprovalsController> {
                  ...
                  children: [
                    Expanded(
                      child: ListView.builder(
                        itemCount: controller.attendanceApprovalListData.value
                                .data?.length ??
                            1,
            ...
            Get.toNamed(AppRoutes.regularizeApproval, arguments: [
              {
                "applicationId": controller
                    .attendanceApprovalListData.value.data
                    ?.elementAt(index)
                    .iOTranId
              }
            ]);
              ...
              builder: (context, constraints) {
                ...
                return Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 16.0),
                    Text(
                      controller.attendanceApprovalListData.value.data
                              ?.elementAt(index)
                              .halfFullDay
                              ?.trim()
                              .toString() ??
