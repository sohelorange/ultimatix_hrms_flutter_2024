...
class CommonGridView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      // This enables scrolling with the main layout
      child: Column(
        children: [
          GridView.builder(
            shrinkWrap: true,
            // This ensures that the GridView only takes up as much space as it needs
            physics: const NeverScrollableScrollPhysics(),
            // Prevents the grid from scrolling independently
              ...
              return Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: statusData[index]['color']
                      .withValues(alpha: 0.1), // Set the background color
                ),
                child: Row(
                  children: [
                    statusData[index]['icon'].toString().isEmpty
                        ...
                        : CommonAppImageSvg(
                            imagePath: statusData[index]['icon'],
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        CommonText(
                          ...
                          color: AppColors.colorDarkBlue.withValues(alpha: 0.5),
                          fontSize: 12,
                          fontWeight: AppFontWeight.w400,
                        ),
                      ],
